...
<body>
    <div class="container col-12 ">
        <div class=" row row-cols-1  justify-content-center col-12 mt-3 ">
            ...
            <form:form class="bg-dark px-5 text-light pb-3 col-3" method="POST" action="/shows/new" modelAttribute="show">
            <h1>Crear Programa</h1>
                ...
                <input class="btn btn-primary btn" type="submit" value="Crear"/>
